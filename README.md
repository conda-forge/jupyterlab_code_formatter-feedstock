...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlab_code_formatter-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlab_code_formatter-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlab_code_formatter
# for installing globally
pixi global install jupyterlab_code_formatter
```
...
It is possible to list all of the versions of `jupyterlab_code_formatter` available on your platform:
...
```
pixi search jupyterlab_code_formatter --channel conda-forge
```
